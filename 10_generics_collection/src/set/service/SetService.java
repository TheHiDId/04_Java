...
public class SetService {
	...
	public void test3() {
		...
		// snacks 셋에 저장된 데이터를 이용해 ArrayList 생성
	 ...
	 */
	public void test4() {
		// Set<String> set = new HashSet<String>(); // 순서를 저장하는 셋
		Set<String> set = new TreeSet<String>(); // 오름차순 정렬 셋
	...
	/**
	 * 로또 번호 6개(중복 없고 오름차순 정렬)가 담긴 문자열 반환
	 * @return 로또 번호가 담긴 문자열
	 */
